          ...
          <div className="bg-gray-50 rounded-lg p-6 space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 p-3 bg-white border rounded-lg">
                ...
                <Button size="sm" variant="outline" onClick={() => copyToClipboard(selectedCryptoData?.address || "")}>
            ...
            <div className="text-sm text-gray-600">
              ...
              <p className="mt-2 text-xs">
                Please send the exact equivalent amount in {selectedCryptoData?.symbol} to the address above. You will
                receive a confirmation email once the transaction is detected on the blockchain.
              </p>
            </div>
          </div>
        )}
