...
const CompanyDocumentsSection = () => (
  <section
    ...
    className="bg-gradient-to-br from-brand-emerald/10 via-white to-brand-navy/10 py-24 px-6 border-t border-gray-100"
  >
    <div className="max-w-5xl mx-auto">
      ...
      <p className="text-center text-gray-700 mb-12 max-w-2xl mx-auto text-xl font-semibold drop-shadow">
        Access important WealthWise documents for your reference and client onboarding. Click to view or download each
        official document.
      </p>
