...
import { Zap, Rocket, Code, Palette, Globe, Layers } from "lucide-react";
            ...
            <CardContent className="p-8">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Real-time data from your connected development platforms
                </p>
              </div>
              
              <ProjectsShowcase 
                vercelToken={apiKeys.vercel} 
                figmaToken={apiKeys.figma}
              />
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 text-sm">
                Connect your accounts to see live project data, deployment status, and design files directly in your dashboard.
              </p>
            </CardContent>
          </Card>
        </div>
