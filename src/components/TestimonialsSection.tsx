...
const testimonials = [
  {
    ...
    quote:
      "WealthWise recovered my lost investment when I thought all hope was lost. Their professionalism and dedication are unmatched. I can't thank them enough for giving me my financial life back.",
    rating: 5,
  ...
  },
  {
    ...
    location: "London, UK",
    quote:
      "After falling for a sophisticated online scam, I was devastated. The team at WealthWise was not only empathetic but incredibly effective. They guided me through the whole process and successfully recovered a significant portion of my funds.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "The educational resources provided by WealthWise on scam prevention are invaluable. Their consultants are knowledgeable and helped me secure my digital assets. Highly recommended for anyone looking to protect their wealth.",
    rating: 5,
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 animate-fade-in">
        {testimonials.map((testimonial) => (
          <div
            ...
            className="relative bg-white border border-gray-200 rounded-3xl shadow-2xl hover:shadow-brand-gold/30 transition-shadow duration-300 p-10 flex flex-col justify-between h-full animate-fade-in group overflow-hidden"
          >
            <img
              src={testimonial.image || "/placeholder.svg"}
              alt={testimonial.name}
              className="absolute -top-8 right-5 w-20 h-20 rounded-full border-4 border-brand-emerald shadow-xl object-cover z-30"
            />
            <div>
