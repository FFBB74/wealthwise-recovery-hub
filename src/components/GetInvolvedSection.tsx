...
const resources = [
  {
    ...
    description:
      "Our comprehensive guide on identifying and avoiding common online and investment scams. Knowledge is your first line of defense.",
  ...
  },
  {
    ...
    description:
      "Join our experts for a free webinar on best practices for cryptocurrency security and protecting your digital wallet.",
  ...
  },
  {
    ...
    description:
      "Unsure if you have a case? Get a confidential and no-obligation evaluation from our team of recovery specialists.",
  ...
  <section id="get-involved" className="bg-gray-50 py-24 px-6">
    <div className="max-w-6xl mx-auto">
      ...
      <p className="text-center text-gray-600 mb-16 max-w-3xl mx-auto text-2xl leading-relaxed font-semibold">
        Empower yourself with knowledge. We provide free resources to help you safeguard your assets and make informed
        financial decisions.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 animate-fade-in">
        {resources.map((resource) => (
          <div
            key={resource.title}
            className="bg-white border border-gray-200 rounded-3xl shadow-xl hover:shadow-brand-emerald/20 transition-shadow duration-300 p-8 flex flex-col text-center items-center"
          >
