...
const stats = [
  ...
  },
  {
    ...
    description:
      "Our proactive security measures have helped clients drastically reduce their exposure to future scams.",
  },
  {
    icon: Users,
    value: "10,000+",
  ...
  <section id="stats" className="bg-gradient-to-br from-brand-navy to-slate-800 text-white py-24 px-6">
    <div className="max-w-6xl mx-auto">
      ...
      <p className="text-center text-gray-300 mb-16 max-w-3xl mx-auto text-2xl leading-relaxed font-semibold">
        Our results speak for themselves. We combine advanced technology with deep investigative experience to deliver
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 animate-fade-in">
        {stats.map((stat) => (
          <div
            key={stat.label}
            className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center flex flex-col items-center hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2"
          >
